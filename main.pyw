...
class App(ctk.CTk):
   def __init__(self):
      ...
      self.txt_Port = ctk.CTkEntry(master=self.frame, width= 40, placeholder_text="Port")
   ...
   def Start_server(self):
      ...
      svr_thread = threading.Thread(target=self.server.startServer, args=(int(self.txt_Port.get()),))
      svr_thread.start()
